...
export default function mission({ navigation, route, onPress }) {
  ...
  async function history() {
    const resposne = await apiservice({
      path: "/event/findidjoinEvent/" + dataEV.mission_List.id,
      method: "get",
    ...
    // console.log(gethistory.data[0].joinEvent_id);
          ...
          <View style={styles.background}>
            <View style={{ paddingHorizontal: 20 }}>
              <View style={styles.view}>
                <Text style={styles.text}>สะสมแต้ม</Text>
                {/* <TouchableOpacity
