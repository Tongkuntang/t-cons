...
export default function index({ navigation, route }) {
  ...
  async function callApi() {
    const resposne = await apiservice({
      ...
      body: {
        event_id: null,
        mission_id: datadetail.id,
        img_event: datadetail.img_List[0],
        event_name: datadetail.titel,
        Type: "UP",
        uid: user.id,
        total_distance: datadetail.distance * 1000,
        last_distance: 0,
        reward_Info: datadetail.reward,
