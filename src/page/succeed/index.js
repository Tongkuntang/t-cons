    ...
    <View style={styles.container}>
      ...
      >
        <Headerdetail
          ...
          item={story != undefined && story.event_name}
              ...
              {state ? (
                ...
                <View>
                  ...
                  <Text style={styles.textcat}>
                    {story != undefined && story.event_name}
                  </Text>
                  <Image
                    style={styles.imgcat}
                    source={{
                      uri:
                        "https://api.sosorun.com/api/imaged/get/" + story !=
                          undefined && story.img_event,
                    }}
                  />
        ...
        >
          <Text style={styles.texttime}>
            {timeformet(
              Math.floor(story != undefined && story.running_Time / 3600)
            )}{" "}
            :{" "}
            {timeformet(
              Math.floor((story != undefined && story.running_Time % 3600) / 60)
            )}{" "}
            :{" "}
            {timeformet(
              Math.floor((story != undefined && story.running_Time % 3600) % 60)
          ...
          <View style={styles.viewtext}>
            ...
            <View style={styles.viewsmall}>
              ...
              <Text style={styles.text2}>
                {(story != undefined && story.last_distance / 1000).toFixed(2)}{" "}
                กม.
              </Text>
            </View>
            <View style={styles.viewsmall}>
          ...
          <View style={styles.view}>
            <Text style={styles.text3}>
              ...
              {(
                (story != undefined &&
                  story.total_distance / story != undefined &&
                  story.running_Time) * 3.6
              ).toFixed(2)}{" "}
              กม. / ชม.
            </Text>
          </View>
